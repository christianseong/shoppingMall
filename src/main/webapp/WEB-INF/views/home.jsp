...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/hipster/resources/assets/img/neck.ico">

	<!-- CSS here -->
	<link rel="stylesheet" href="/hipster/resources/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/owl.carousel.min.css">
    ...
    <link rel="stylesheet" href="/hipster/resources/assets/css/animate.min.css">
    <link rel="stylesheet" href="/hipster/resources/assets/css/animated-headline.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/magnific-popup.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/fontawesome-all.min.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/themify-icons.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/slick.css">
	<link rel="stylesheet" href="/hipster/resources/assets/css/nice-select.css">
...
<body>
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li><a href="/hipster/resources/html/blog.html">Blog</a>
                                                <ul class="submenu">
                                                    ...
                                                    <li><a href="/hipster/resources/html/blog_details.html">Blog Details</a></li>
    ...
    <main>
        ...
        <section class="about-area section-padding30 position-relative">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <img src="/hipster/resources/assets/img/gallery/signature.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-shape">
                <img src="/hipster/resources/assets/img/gallery/about-shape.png" alt="">
            </div>
        </section>
        <!-- About-2 Area End -->
        <!--? Services Area Start -->
                ...
                <div class="row team-active dot-style">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="/hipster/resources/assets/img/gallery/team1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="/hipster/resources/assets/img/gallery/team2.png" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            <div class="team-img">
                                <img src="/hipster/resources/assets/img/gallery/team3.png" alt="">
                            </div>
                            <div class="team-caption">
                                <span>Master Barber</span>
        ...
        <div class="best-pricing section-padding2 position-relative">
            ...
            <div class="pricing-img">
                <img class="pricing-img1" src="/hipster/resources/assets/img/gallery/pricing1.png" alt="">
                <img class="pricing-img2" src="/hipster/resources/assets/img/gallery/pricing2.png" alt="">
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(/hipster/resources/assets/img/gallery/gallery1.png);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(/hipster/resources/assets/img/gallery/gallery2.png);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(/hipster/resources/assets/img/gallery/gallery3.png);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="box snake mb-30">
                            <div class="gallery-img " style="background-image: url(/hipster/resources/assets/img/gallery/gallery4.png);"></div>
                            <div class="overlay"></div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Gallery Area End -->
        <!-- Cut Details Start -->
        <div class="cut-details section-bg section-padding2" data-background="/hipster/resources/assets/img/gallery/section_bg02.png">
           <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="/hipster/resources/assets/img/gallery/home-blog1.png" alt="">
                                    <!-- Blog date -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="home-blog-single mb-30">
                            <div class="blog-img-cap">
                                <div class="blog-img">
                                    <img src="/hipster/resources/assets/img/gallery/home-blog2.png" alt="">
                                    <!-- Blog date -->
                                    <div class="blog-date text-center">
                                        <span>24</span>
                                        <p>Now</p>
    ...
    <footer>
        <!--? Footer Start-->
        <div class="footer-area section-bg" data-background="/hipster/resources/assets/img/gallery/footer_bg.png">
            <div class="container">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="/hipster/resources/assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script src="/hipster/resources//assets/js/vendor/modernizr-3.5.0.min.js"></script>
    ...
    <script src="/hipster/resources//assets/js/hover-direction-snake.min.js"></script>
