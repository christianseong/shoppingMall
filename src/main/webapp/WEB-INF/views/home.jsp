...
<link rel="stylesheet"
	href="/hipster/resources/assets/css/bootstrap.min.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/custom.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/owl.carousel.min.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/slicknav.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/flaticon.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/gijgo.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/animate.min.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/animated-headline.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/magnific-popup.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/fontawesome-all.min.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/themify-icons.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/slick.css">
<link rel="stylesheet"
	href="/hipster/resources/assets/css/nice-select.css">
<link rel="stylesheet" href="/hipster/resources/assets/css/style.css">
				...
				<div class="container-fluid">
					<div class="row align-items-center">
						...
						<div class="col-xl-2 col-lg-2 col-md-1">
							<div class="logo">
								<a href="?page=home"><img
									src="/hipster/resources/assets/img/logo/LogoMakr_9EJ9V9.png"
									alt=""></a>
							</div>
						</div>
								...
								<div class="main-menu f-right d-none d-lg-block">
									<nav>
										<ul id="navigation">
											...
											<li><a href="/hipster/resources/html/blog.html">Blog</a>
												<ul class="submenu">
													<li><a href="/hipster/resources/html/blog.html">Blog</a></li>
													<li><a
														href="/hipster/resources/html/blog_details.html">Blog
															Details</a></li>
													<li><a href="/hipster/resources/html/elements.html">Element</a></li>
												</ul></li>
											<li><a href="/hipster/resources/html/contact.html">Contact</a></li>
										</ul>
									</nav>
								</div>
<c:choose>
									...
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												...
												<img src="/hipster/resources/assets/img/logo/popup.png"/>
												  <h5 class="modal-title">Modal title</h5>
												<button type="button btn-primary" class="close" data-dismiss="modal"
													aria-label="Close">
											...
											<div class="modal-body">
												<div class="sns-login-btn-wrapper">
													...
													<a id="kakaoLoginBtn" class="sns-btn-kakao" href="https://kauth.kakao.com/oauth/authorize?client_id=2b2c7e111b27cbb5f391a0825ae806af&redirect_uri=http://localhost:8080/hipster/login&response_type=code">
...
<c:otherwise>
	...
	<main>
						...
						<div class="row">
							<div class="col-xl-8 col-lg-9 col-md-11 col-sm-10">
								<div class="hero__caption">
									<span data-animation="fadeInUp" data-delay="0.2s">with
										patrick potter</span>
									<h1 data-animation="fadeInUp" data-delay="0.5s">Our Hair
										Style make your look elegance</h1>
								</div>
							</div>
						</div>
					</div>
		...
		<section class="about-area section-padding30 position-relative">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-11">
						<!-- about-img -->
						<div class="about-img ">
							<img src="/hipster/resources/assets/img/gallery/about.png" alt="">
						</div>
					</div>
					<div class="col-lg-6 col-md-12">
						<div class="about-caption">
							...
							<p class="mb-30 pera-bottom">Brook presents your services
								with flexible, convenient and cdpoe layouts. You can select your
								favorite layouts & elements for cular ts with unlimited
								ustomization possibilities. Pixel-perfreplication of the
								designers is intended.</p>
							<p class="pera-top mb-50">Brook presents your services with
								flexible, convefnient and ent anipurpose layouts. You can select
								your favorite.</p>
							<img src="/hipster/resources/assets/img/gallery/signature.png"
								alt="">
						</div>
					</div>
				</div>
			...
			<div class="about-shape">
				<img src="/hipster/resources/assets/img/gallery/about-shape.png"
					alt="">
			</div>
		</section>
		<!-- About-2 Area End -->
				...
				<div class="row team-active dot-style">
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
						<div class="single-team mb-80 text-center">
							<div class="team-img">
								<img src="/hipster/resources/assets/img/gallery/team1.png"
									alt="">
							</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
						<div class="single-team mb-80 text-center">
							<div class="team-img">
								<img src="/hipster/resources/assets/img/gallery/team2.png"
									alt="">
							</div>
							<div class="team-caption">
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
						<div class="single-team mb-80 text-center">
							<div class="team-img">
								<img src="/hipster/resources/assets/img/gallery/team3.png"
									alt="">
							</div>
							<div class="team-caption">
								<span>Master Barber</span>
		...
		<div class="best-pricing section-padding2 position-relative">
			...
			<div class="pricing-img">
				<img class="pricing-img1"
					src="/hipster/resources/assets/img/gallery/pricing1.png" alt="">
				<img class="pricing-img2"
					src="/hipster/resources/assets/img/gallery/pricing2.png" alt="">
			</div>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="box snake mb-30">
							<div class="gallery-img "
								style="background-image: url(/hipster/resources/assets/img/gallery/gallery1.png);"></div>
					...
					<div class="col-lg-8 col-md-6 col-sm-6">
						<div class="box snake mb-30">
							<div class="gallery-img "
								style="background-image: url(/hipster/resources/assets/img/gallery/gallery2.png);"></div>
							<div class="overlay"></div>
						</div>
					</div>
					<div class="col-lg-8 col-md-6 col-sm-6">
						<div class="box snake mb-30">
							<div class="gallery-img "
								style="background-image: url(/hipster/resources/assets/img/gallery/gallery3.png);"></div>
							<div class="overlay"></div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="box snake mb-30">
							<div class="gallery-img "
								style="background-image: url(/hipster/resources/assets/img/gallery/gallery4.png);"></div>
							<div class="overlay"></div>
						</div>
					</div>
				</div>
		...
		<div class="cut-details section-bg section-padding2"
			data-background="/hipster/resources/assets/img/gallery/section_bg02.png">
			<div class="container">
				<div class="cut-active dot-style">
					<div class="single-cut">
						...
						<div class="cut-descriptions">
							<p>Vestibulum varius, velit sit amet tempor efficitur, ligula
								mi lacinia libero, vehicula dui nisi eget purus. Integer cursus
								nibh non risus maximus dictum. Suspendis.</p>
				...
				<div class="row">
					<div class="col-xl-6 col-lg-6 col-md-6">
						<div class="home-blog-single mb-30">
							<div class="blog-img-cap">
								<div class="blog-img">
									<img src="/hipster/resources/assets/img/gallery/home-blog1.png"
										alt="">
									<!-- Blog date -->
					...
					<div class="col-xl-6 col-lg-6 col-md-6">
						<div class="home-blog-single mb-30">
							<div class="blog-img-cap">
								<div class="blog-img">
									<img src="/hipster/resources/assets/img/gallery/home-blog2.png"
										alt="">
									<!-- Blog date -->
									<div class="blog-date text-center">
										<span>24</span>
	...
	<footer>
		...
		<div class="footer-area section-bg"
			data-background="/hipster/resources/assets/img/gallery/footer_bg.png">
			<div class="container">
							...
							<div class="single-footer-caption mb-50">
								...
								<div class="footer-tittle">
									<div class="footer-pera">
										<p class="info1">Receive updates and latest news direct
											from Simply enter.</p>
									</div>
								</div>
	...
	<script src="/hipster/resources//assets/js/owl.carousel.min.js"></script>
	<script src="/hipster/resources//assets/js/slick.min.js"></script>
	<!-- One Page, Animated-HeadLin -->
	<script src="/hipster/resources//assets/js/wow.min.js"></script>
	<script src="/hipster/resources//assets/js/animated.headline.js"></script>
	<script src="/hipster/resources//assets/js/jquery.magnific-popup.js"></script>

	<!-- Date Picker -->
	<script src="/hipster/resources//assets/js/gijgo.min.js"></script>
	<!-- Nice-select, sticky -->
	<script src="/hipster/resources//assets/js/jquery.nice-select.min.js"></script>
	<script src="/hipster/resources//assets/js/jquery.sticky.js"></script>

	<!-- counter , waypoint,Hover Direction -->
	<script src="/hipster/resources//assets/js/jquery.counterup.min.js"></script>
	<script src="/hipster/resources//assets/js/waypoints.min.js"></script>
	<script src="/hipster/resources//assets/js/jquery.countdown.min.js"></script>
	<script
		src="/hipster/resources//assets/js/hover-direction-snake.min.js"></script>

	<!-- contact js -->
	<script src="/hipster/resources//assets/js/contact.js"></script>
	<script src="/hipster/resources//assets/js/jquery.form.js"></script>
	<script src="/hipster/resources//assets/js/jquery.validate.min.js"></script>
	<script src="/hipster/resources//assets/js/mail-script.js"></script>
	<script src="/hipster/resources//assets/js/jquery.ajaxchimp.min.js"></script>

	<!-- Jquery Plugins, main Jquery -->
	<script src="/hipster/resources/ /assets/js/plugins.js"></script>
	<script src="/hipster/resources//assets/js/main.js"></script>
